...
pub async fn register_routes(services: RpcServiceContext) {
    ...
    router.register("message/reaction/add", {
    ...
    router.register("message/reaction/remove", {
        let services = services.clone();
        Box::new(move |body, ctx| {
            let services = services.clone();
    ...
    router.register("message/reaction/list", {
        let services = services.clone();
        Box::new(move |body, ctx| {
            let services = services.clone();
    ...
    router.register("message/reaction/stats", {
        let services = services.clone();
        Box::new(move |body, ctx| {
            let services = services.clone();
