...
ALTER TABLE public.privchat_file_uploads ADD COLUMN IF NOT EXISTS encryption_version integer DEFAULT 0 NOT NULL;
ALTER TABLE public.privchat_file_uploads ADD COLUMN IF NOT EXISTS cek text;
